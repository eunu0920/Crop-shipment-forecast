...
# 데이터 로드
file_path = r'C:\Users\kimeu\OneDrive\사진\바탕 화면\농작물_웹페이지\pages2\cucumber_jincheon.xlsx'
...
col_lst = ['temp', 'max_Temp',
       'min_Temp', 'hum', 'wind', 'rain',
       'sun_Time', 'sun_Qy', 'condens_Time', 'gr_Temp', 'soil_Temp', 'soil_Wt']
